...
const DailyPriceList = () => {
  ...
  useEffect(() => {
    try {
      setTotalPages(Math.ceil(Vegetable.length / itemsPerPage));
    } catch (error) {
  ...
  const endItem = Math.min(startItem + itemsPerPage, Vegetable.length);
    ...
    <div>
      <TableContainer component={Paper} className="table-container">
        <Table className="table">
          ...
          <TableBody>
            {Vegetable.slice(startItem, endItem).map((price, index) => (
